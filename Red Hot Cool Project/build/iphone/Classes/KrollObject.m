...
//@interface RedHotCoolProjectObject : NSObject
//@end

@interface RedHotCoolProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[RedHotCoolProjectObject class]])
		{
			for (NSString *key in [[(RedHotCoolProjectObject*)o modules] allKeys])
			{
