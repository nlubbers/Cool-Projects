...
// in simulator we redefine to format for RedHotCoolProject Developer console
...
{\
	NSString * exceptionName = [@"org.redhotcoolproject." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.redhotcoolproject";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIRedHotCoolProjectNativeItemNone = -1, 
	UIRedHotCoolProjectNativeItemSpinner = -2,
	UIRedHotCoolProjectNativeItemProgressBar = -3,
	
	UIRedHotCoolProjectNativeItemSlider = -4,
	UIRedHotCoolProjectNativeItemSwitch = -5,
	UIRedHotCoolProjectNativeItemMultiButton = -6,
	UIRedHotCoolProjectNativeItemSegmented = -7,
	
	UIRedHotCoolProjectNativeItemTextView = -8,
	UIRedHotCoolProjectNativeItemTextField = -9,
	UIRedHotCoolProjectNativeItemSearchBar = -10,
	
	UIRedHotCoolProjectNativeItemPicker = -11,
	UIRedHotCoolProjectNativeItemDatePicker = -12,
	
	UIRedHotCoolProjectNativeItemInfoLight = -13,
	UIRedHotCoolProjectNativeItemInfoDark = -14,
	
	UIRedHotCoolProjectNativeItemDisclosure = -15,
	
	UIRedHotCoolProjectNativeItemContactAdd = -16
};
